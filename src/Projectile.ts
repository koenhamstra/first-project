class Projectile{
    ...
    public move = () => {
        this.ctx.clearRect(this.xPos, this.yPos, 80, 80); //Only clears the area directly around the projectile. Doesn't clear the entire canvas because that would make everything disappear
        this.ctx.drawImage(this.image,this.xPos, this.yPos);
        this.xPos -= 2;     
        // console.log("moves");  
    }
